...
(* OASIS_START *)
(* DO NOT EDIT (digest: 14c77e0224faa2bde8081048057a139f) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("example_ini",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$example_ini", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "example_dim"
                        ]
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ini.ml"});
               Test
                 ({
                     cs_name = "example_ini";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "example_ini"
                        ]
                   });
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/Drup/tyre.git";
                      src_repo_browser = Some "https://github.com/Drup/tyre";
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\191\132\207\238~\159P]\225\029\180\143\167.\158]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
