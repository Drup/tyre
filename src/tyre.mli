...
static val conv_fail :
  ('a -> ('b, exn) Result.result) expr -> ('b -> 'a) expr -> 'a t -> 'b t
...
static val opt : 'a t -> 'a option t
(** [opt tyre] matches either [tyre] or the empty string. Similar to {!Re.opt}. *)

static val alt : 'a t -> 'b t -> [`Left of 'a | `Right of 'b] t
...
static val (<|>) : 'a t -> 'b t -> [`Left of 'a | `Right of 'b] t
(** [t <|> t'] is [alt t t']. *)

static val (<&>) : 'a t -> 'b t -> ('a * 'b) t
(** [t <&> t'] is [seq t t']. *)

static val ( *>) : _ t -> 'a t -> 'a t
(** [ ti *> t ] is [prefix ti t]. *)

static val (<* ) : 'a t -> _ t -> 'a t
(** [ t <* ti ] is [suffix t ti]. *)
...
static val bool : bool t
(** [bool] matches [true|false] and returns the matched boolean. *)

static val list : 'a t -> 'a list t
(** [list e] is similar to [rep e], but returns a list. *)

static val terminated_list : sep:_ t -> 'a t -> 'a list t
(** [terminated_list ~sep tyre] is [ list (tyre <* sep) ]. *)

static val separated_list : sep:_ t -> 'a t -> 'a list t
...
static val start : unit t
static val stop : unit t

static val word : 'a t -> 'a t
static val whole_string : 'a t -> 'a t
static val longest : 'a t -> 'a t
static val shortest : 'a t -> 'a t
static val first : 'a t -> 'a t
static val greedy : 'a t -> 'a t
static val non_greedy : 'a t -> 'a t
static val nest : 'a t -> 'a t
...
static val exec : 'a re -> (?pos:int -> ?len:int -> string -> ('a, 'a error) Result.result) expr
...
static val execp : 'a re -> (?pos:int -> ?len:int -> string -> bool) expr
